...
return array(
	 ...
	 * @type string
	 */
	'settings_config_path' => config_path('settings/'),
	 ...
	 */
	'menu' => array(
			'Funding' => array('donations', 'donors'),
			'Blog' => array('posts', 'comments'),
			'users',
			'Static Pages' => array('settings.about', 'settings.views', 'settings.contact'),
